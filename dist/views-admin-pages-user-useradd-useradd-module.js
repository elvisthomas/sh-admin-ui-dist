...
var UseraddComponent = /** @class */ (function () {
    ...
    UseraddComponent.prototype.changeCompany = function (companyId) {
        if (this.user.company) {
            if (confirm("Are you sure you want to change " + this.user.firstName + "'s company from to (new company)? This change will apply all consumption to (new company).")) {
                console.log("coming ----------- ");
            }
        }
    };
