    ...
    ListComponent.prototype.getCompanies = function () {
        ...
        this.globalService.getCompanies(this.companySearch).subscribe(function (data) {
            ...
            if (error && error.error && error.error.message) {
                ...
                _this.toastr.error(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].reponseCode[error.status], 'Error ' + error.status);
            }
        });
    };
