...
var DefaultLayoutComponent = /** @class */ (function () {
    function DefaultLayoutComponent(router, jwtService, globalService) {
        ...
        this.isIframe = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].isIframe;
        ...
        this.reportingUrl = "https://shpy.azurewebsites.net/api/KlipfolioAccess?code=faQfD4q6DyTHdCmTyWdS4klAA4j2mE543Z/zqx9AHNJsDWj7RKAw7w==&email=" + this.currentUser.emailAddress + "&createdt=" + this.currentUser.createDate;
    }
